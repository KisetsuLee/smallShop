 ...
 * Date: 2020-03-24
 * Time: 23:21
 * subject login(token) -> security manager -> realm(authenticationInfo authorizationInfo)
 * -> credentialsMatcher & permissionResolver & rolePermissionResolver
 * -> shiro filter chain -> servlet filter chain
 */
@Service
